 ...
 * through pages of data. This custom ViewPager implementation
 * updates content based on
 *
 * @author Eduardo Duarte (<a href="mailto:emod@ua.pt">emod@ua.pt</a>))
 * @version 1.0
 */
public class TaxiItemViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
         ...
         * @see TaxiItemViewPager#SCROLL_STATE_IDLE
         * @see TaxiItemViewPager#SCROLL_STATE_DRAGGING
         * @see TaxiItemViewPager#SCROLL_STATE_SETTLING
         */
    ...
    public TaxiItemViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public TaxiItemViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
...
*/
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(TaxiItemViewPager.class.getName());
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(TaxiItemViewPager.class.getName());
