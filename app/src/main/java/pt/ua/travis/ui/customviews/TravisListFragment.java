...
/**
 * The implementation of the fragment that will display content dynamically and, while that
 * content is loading, will display an indeterminate progress indicator.
 * This implementation serves as an alternative to a ListFragment.
 *
 * @author Eduardo Duarte (<a href="mailto:emod@ua.pt">emod@ua.pt</a>))
 * @version 1.0
 */
public class TravisListFragment extends TravisFragment {
     ...
     * consider including the standard layout {@link R.layout#fragment_travis_list}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_travis_list, container, false);
    }
    ...
    /**
     * The default content for a SherlockProgressListFragment has a TextView that can
     ...
     * behavior of SherlockProgressListFragment is to start with the list not being shown, only
