...
import pt.ua.travis.backend.android.mobilebackend.model.FilterDto;
...
public class Filter {
    ...
    /**
     * Creates a {@link Filter} for GREATER_THAN_EQUAL operation.
     * 
     * @param propertyName Name of the target property.
     * @param value Value for this operation.
     * @return {@link Filter} for this operation.
    ...
    /**
     * Creates a {@link Filter} for NOT_EQUAL operation.
     * 
     * @param propertyName Name of the target property.
     * @param value Value for this operation.
     * @return {@link Filter} for this operation.
    ...
    /**
     * Creates a {@link Filter} for IN operation.
     * 
     * @param propertyName Name of the target property.
