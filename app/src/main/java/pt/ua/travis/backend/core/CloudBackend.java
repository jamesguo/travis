...
import pt.ua.travis.backend.android.mobilebackend.Mobilebackend;
import pt.ua.travis.backend.android.mobilebackend.model.EntityDto;
import pt.ua.travis.backend.android.mobilebackend.model.EntityListDto;
import pt.ua.travis.backend.android.mobilebackend.model.QueryDto;
...
public class CloudBackend {
    ...
    private Mobilebackend getMBSEndpoint() {
        ...
        return new Mobilebackend.Builder(AndroidHttp.newCompatibleTransport(), new JacksonFactory(),
                hri)
