...
package pt.ua.travis.backend.android.mobilebackend;

import pt.ua.travis.backend.android.mobilebackend.model.BlobAccess;
  ...
  public class BlobEndpoint {
    ...
    public class GetDownloadUrl extends MobilebackendRequest<BlobAccess> {
      ...
      protected GetDownloadUrl(java.lang.String bucketName, java.lang.String objectPath) {
        super(Mobilebackend.this, "GET", REST_PATH, null, BlobAccess.class);
        this.bucketName = com.google.api.client.util.Preconditions.checkNotNull(bucketName, "Required parameter bucketName must be specified.");
        this.objectPath = com.google.api.client.util.Preconditions.checkNotNull(objectPath, "Required parameter objectPath must be specified.");
      }
  ...
  public class EndpointV1 {
    ...
    public class Delete extends MobilebackendRequest<EntityDto> {
      ...
      protected Delete(java.lang.String kind, java.lang.String id) {
        super(Mobilebackend.this, "DELETE", REST_PATH, null, EntityDto.class);
     ...
     *
     * @param content the {@link pt.ua.travis.backend.android.mobilebackend.model.EntityListDto}
     * @return the request
     */
    public DeleteAll deleteAll(EntityListDto content) throws java.io.IOException {
    ...
    public class DeleteAll extends MobilebackendRequest<EntityListDto> {
       ...
       * @since 1.13
       */
      protected DeleteAll(EntityListDto content) {
        super(Mobilebackend.this, "POST", REST_PATH, content, EntityListDto.class);
      }
    ...
    public class Get extends MobilebackendRequest<EntityDto> {
      ...
      protected Get(java.lang.String kind, java.lang.String id) {
        super(Mobilebackend.this, "GET", REST_PATH, null, EntityDto.class);
        this.kind = com.google.api.client.util.Preconditions.checkNotNull(kind, "Required parameter kind must be specified.");
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
     ...
     * @return the request
     */
    public GetAll getAll(EntityListDto content) throws java.io.IOException {
    ...
    public class GetAll extends MobilebackendRequest<EntityListDto> {
       ...
       * @since 1.13
       */
      protected GetAll(EntityListDto content) {
        super(Mobilebackend.this, "POST", REST_PATH, content, EntityListDto.class);
      }
     ...
     *
     * @param kind
     * @param content the {@link pt.ua.travis.backend.android.mobilebackend.model.EntityDto}
     * @return the request
     */
    public Insert insert(java.lang.String kind, EntityDto content) throws java.io.IOException {
    ...
    public class Insert extends MobilebackendRequest<EntityDto> {
       ...
       * @since 1.13
       */
      protected Insert(java.lang.String kind, EntityDto content) {
        super(Mobilebackend.this, "POST", REST_PATH, content, EntityDto.class);
        this.kind = com.google.api.client.util.Preconditions.checkNotNull(kind, "Required parameter kind must be specified.");
      }
     ...
     * @return the request
     */
    public InsertAll insertAll(EntityListDto content) throws java.io.IOException {
    ...
    public class InsertAll extends MobilebackendRequest<EntityListDto> {
       ...
       * @since 1.13
       */
      protected InsertAll(EntityListDto content) {
        super(Mobilebackend.this, "POST", REST_PATH, content, EntityListDto.class);
      }
     ...
     *
     * @param content the {@link pt.ua.travis.backend.android.mobilebackend.model.QueryDto}
     * @return the request
     */
    public List list(QueryDto content) throws java.io.IOException {
    ...
    public class List extends MobilebackendRequest<EntityListDto> {
       ...
       * @since 1.13
       */
      protected List(QueryDto content) {
        super(Mobilebackend.this, "POST", REST_PATH, content, EntityListDto.class);
      }
     ...
     * @return the request
     */
    public Patch patch(java.lang.String kind, java.lang.String id, EntityDto content) throws java.io.IOException {
    ...
    public class Patch extends MobilebackendRequest<EntityDto> {
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String kind, java.lang.String id, EntityDto content) {
        super(Mobilebackend.this, "PATCH", REST_PATH, content, EntityDto.class);
        this.kind = com.google.api.client.util.Preconditions.checkNotNull(kind, "Required parameter kind must be specified.");
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
     ...
     * @return the request
     */
    public Update update(java.lang.String kind, EntityDto content) throws java.io.IOException {
    ...
    public class Update extends MobilebackendRequest<EntityDto> {
       ...
       * @since 1.13
       */
      protected Update(java.lang.String kind, EntityDto content) {
        super(Mobilebackend.this, "POST", REST_PATH, content, EntityDto.class);
        this.kind = com.google.api.client.util.Preconditions.checkNotNull(kind, "Required parameter kind must be specified.");
      }
     ...
     * @return the request
     */
    public UpdateAll updateAll(EntityListDto content) throws java.io.IOException {
    ...
    public class UpdateAll extends MobilebackendRequest<EntityListDto> {
       ...
       * @since 1.13
       */
      protected UpdateAll(EntityListDto content) {
        super(Mobilebackend.this, "POST", REST_PATH, content, EntityListDto.class);
      }
