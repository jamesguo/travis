 ...
 * @version 1.0
 */
public class BootstrapAutoCompleteEditText extends AutoCompleteTextView {

    private boolean roundedCorners = false;

    public BootstrapAutoCompleteEditText(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initialise(attrs);
    }

    public BootstrapAutoCompleteEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialise(attrs);
    }

    public BootstrapAutoCompleteEditText(Context context) {
        super(context);
        initialise(null);
    }
    ...
    private void setBackgroundDrawable(String state)
    {
        ...
        if(roundedCorners){
            ...
            if (state.equals(BootstrapEditText.BOOTSTRAP_EDIT_TEXT_SUCCESS)){
                this.setBackgroundResource(R.drawable.edittext_background_rounded_success);
            } else if (state.equals(BootstrapEditText.BOOTSTRAP_EDIT_TEXT_WARNING)){
                this.setBackgroundResource(R.drawable.edittext_background_rounded_warning);
            } else if (state.equals(BootstrapEditText.BOOTSTRAP_EDIT_TEXT_DANGER)){
    ...
    {
        setBackgroundDrawable(BootstrapEditText.BOOTSTRAP_EDIT_TEXT_SUCCESS);
    }
    ...
    {
        setBackgroundDrawable(BootstrapEditText.BOOTSTRAP_EDIT_TEXT_WARNING);
    }
    ...
    {
        setBackgroundDrawable(BootstrapEditText.BOOTSTRAP_EDIT_TEXT_DANGER);
    }
    ...
    {
        setBackgroundDrawable(BootstrapEditText.BOOTSTRAP_EDIT_TEXT_DEFAULT);
    }
